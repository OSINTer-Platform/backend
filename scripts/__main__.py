...
from .couch import app as couch_app
from .fakes import app as fake_app
...
app.add_typer(couch_app, name="couch", no_args_is_help=True)
app.add_typer(fake_app, name="fakes", no_args_is_help=True)
